...
# Modified by Nestor Alvarez, 20160731
...
def performTrial(time, f):
    ...
    for t in range(1, time + 1):
        f.getRoomba().move(f)
        newLoc = f.getLoc()
        xcoords.append(newLoc.getCoords()[0])
        ycoords.append(newLoc.getCoords()[1])
        # TODO
